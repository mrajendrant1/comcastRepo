...
.defaultTestrgr_PageStyle{ display: block; margin-left: auto;margin-right: auto;width:100%;height:630px;position:relative;}</style><style type="text/css" eportal-type="customCss"></style><script type="text/javascript" eportal-type="webRequire">
	require([
		'dojo/parser',
		'dijit/dijit',
...
<div class='defaultTestrgr_PageStyle' eportal-type='ePortalPageOuterDiv'><div class="eportalEditor"><div id="eWidgetOuterContainer_defaultTestrgr" class="container-fluid" eportal-type="eWidget-outerContainer"><div class="row clearfix" eportal-type="Grid Row" id="gridRow_defaultTestrgr_1"><div id="gridColumn_defaultTestrgr_1" class="col-md-12 column" eportal-type="Grid Column"><label eportal-type="Label" class="label" style="word-break: break-all" id="Label_defaultTestrgr_1">label</label><input eportal-type="TextBox" class="form-control" id="TextBox_defaultTestrgr_1"></div></div></div></div>
</div>
